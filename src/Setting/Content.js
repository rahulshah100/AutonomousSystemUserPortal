    ...
    <div style={{ height: '40.2vw' }} className='containerSetting'>
      ...
      <div className="MainList">
        <div className='ListItem'>
          ...
          <button type="button" className="btn btn-dark" onClick={() => OpenSettingItem('Display-Settings')}>Open</button>
        </div><br />
        <div className='ListItem'>
          <span> 2. Audio Settings</span>
          <button type="button" className="btn btn-dark" onClick={() => OpenSettingItem('Audio-Settings')}>Open</button>
        </div><br />
        <div className='ListItem'>
          <span> 3. Accessibility  </span>
          <button type="button" className="btn btn-dark" onClick={() => OpenSettingItem('Accessibility')}>Open</button>
        </div>
      </div>
    </div>
  )
