...
export default function Content(props) {
    ...
    return (
        <div style={{ height: '40.2vw', fontFamily: 'Arial, Helvetica, sans-serif', paddingTop: '60px' }} className="TutorialContainer">
            <Link title='Go Back to Home Page' to="#Home" className='goBack' onClick={() => { props.data("Home") }} style={{ color: 'black', textDecoration: 'none', display: 'inline-block' }}><h3> &larr; Go Back </h3></Link>
            ...
            <div style={{ minHeight: '81%', border: '2px solid black', borderRadius: ' 10px', backgroundColor: 'white', paddingLeft: 10, position: 'relative', marginTop: '30px' }} className="alert">
                <div>
                    <img src="images/card6.png" alt="Tutorial Icon" style={{ zoom: 0.8, marginLeft: 10, marginRight: 10, marginTop: 10 }} />
                    <h3 style={{ color: '#F06449', verticalAlign: 'middle', lineHeight: '25px', fontWeight: 600, display: 'inline-block', marginTop:14 }}>
                        Tutorial Mode
                    </h3>
                    <hr style={{ backgroundColor: 'rgb(255,91,10)', color: 'rgb(255,91,10)', height: '3.5px' }} />
                </div>
                ...
                <div>
                    ...
                    <div style={{ textAlign: 'center', display: 'flex', flexDirection: 'column', justifyContent: 'center', height: '200px', alignItems: 'center', padding: 20 }} className="page5 hide">
                        ...
                        <div style={{ position: 'relative' }} >
                            <div style={{ width: '5px', minHeight: '80px', backgroundColor: 'red', position: 'absolute', top: 0 }}></div>
                            <div style={{ minWidth: '100px', minHeight: '5px', backgroundColor: 'red', position: 'absolute', top: 80, left: -95 }}></div>
                            <div style={{ width: '5px', minHeight: '68px', backgroundColor: 'red', position: 'absolute', top: 80, left: -100 }}></div>
                            <div style={{ color: 'red', position: 'absolute', bottom: -166, left: -117 }}><span style={{ zoom: 4.4 }}> &#8964;</span></div>
                        </div>
                    </div>
                    ...
                    <div style={{ textAlign: 'center', display: 'flex', flexDirection: 'column', justifyContent: 'center', height: '200px', alignItems: 'center', padding: 20 }} className="page6 hide" >
                        ...
                        <div style={{ position: 'relative' }} >
                            ...
                            <div style={{ width: '5px', minHeight: '78px', backgroundColor: 'red', position: 'absolute', top: 90, left: -100 }}></div>
                            <div style={{ color: 'red', position: 'absolute', bottom: -185, left: -117 }}><span style={{ zoom: 4.4 }}> &#8964;</span></div>
                        </div>
                    </div>
                </div>

                <div className='Cardfooter' style={{ position: 'absolute', bottom: 10 }}>
                    <span title='Previous step'>
                    ...
                    <span title='Restart the tutorial'>
